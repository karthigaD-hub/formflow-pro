...
import { Shield, Users, Building2, FileText, CheckCircle, ArrowRight, BarChart3, Lock, Zap } from 'lucide-react';
  ...
  const features = [
    {
      ...
      description: 'Manage multiple bank insurance forms from a single platform',
    },
    {
      icon: FileText,
      title: 'Dynamic Forms',
        ...
        <div className="container relative z-10">
          <div className="mx-auto max-w-4xl text-center">
            ...
            <p className="mx-auto mb-10 max-w-2xl text-lg text-muted-foreground">
              ...
              Built for banks, agents, and customers who demand efficiency.
            </p>
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {[
              ...
              { step: '2', title: 'Select Bank', description: 'Choose your bank and access relevant forms' },
